...
import { LayoutDashboard, Building2, Globe, Settings, LogOut, Home, FileText, Users, Network, Database } from 'lucide-react';
    ...
    return (
        <aside className="w-64 h-screen fixed left-0 top-0 bg-[#0A0A0A] border-r border-[#1F1F1F] flex flex-col z-50">
            <div className="p-6 flex items-center gap-3 border-b border-[#1F1F1F]">
                ...
                <span className="font-bold text-white tracking-tight">CB Admin</span>
            </div>
