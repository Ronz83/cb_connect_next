    ...
    return (
        <div className="w-full max-w-4xl mx-auto relative z-20">
            ...
            <div className="flex justify-center mb-6">
                <div className="inline-flex bg-black/40 backdrop-blur-md p-1 rounded-full border border-white/10 overflow-x-auto">
                    {tabs.map(tab => (
                        <button
                            key={tab.id}
            ...
            <div className="bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-2xl">
                <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-3">
                    ...
                    {/* Keyword Input */}
                    <div className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-4 flex items-center gap-3 focus-within:bg-white/10 focus-within:border-white/20 transition-all">
                        ...
                        <input
                            ...
                            className="bg-transparent text-white placeholder-gray-500 w-full focus:outline-none font-medium"
                            value={searchTerm}
